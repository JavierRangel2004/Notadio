...
export const config = {
  ...
  liveIntervalMs: readNumber(process.env.LIVE_INTERVAL_MS, 2500, { min: 1000, max: 10000 }),
  liveOverlapMs: readNumber(process.env.LIVE_OVERLAP_MS, 5000, { min: 1000, max: 15000 }),
